...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.doctor330.cloud.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.doctor330.cloud.modules.sys.entity.User(null, userId)))){
